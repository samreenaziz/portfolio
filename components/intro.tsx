...
export default function Intro() {
  return (
    <section>
        <div className="flex items-center justify-center sm:pl-10 sm:pr-10">
        ...
        <motion.p
            ...
            className="mb-10 font-medium px-9 pt-4 sm:pt-8 text-4xl text-center sm:mb:0"
            >
        ...
        <motion.div className="flex flex-col sm:flex-row justify-center gap-2 px-4 py-2 text-lg font-medium mt-[-3rem]"
            ...
            <a
                className = "group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale:110 active:scale-115 hover:scale-105 cursor:pointer border border-black/10 transition"
            ...
            <a className="bg-white p-4 text-gray-700 flex items-center gap-2 rounded-full focus:scale-[1.15] hover:text-gray-950 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10"
        ...
        <motion.p
            ...
            animate={{ opacity: 1 }}
            transition={{ type: "tween", delay: 1.0 }}
            className="mb-10 mt-2 font-medium leading-[1.5] p-9 sm:p-8 text-4xl text-center sm:mb:0"
            >
